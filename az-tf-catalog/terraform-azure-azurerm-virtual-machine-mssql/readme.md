...
```hcl
module "kpmg-rg-sa-vmwin-domjoin-mssql-iaas" {
    source                                                      = "git::ssh://git@bitbucket.agile.corp.kpmg.pt:7999/ica/terraform-azure-azurerm-virtual-machine-mssql.git"
