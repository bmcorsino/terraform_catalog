...
```hcl
module "kpmg_sql_server_policies" {
    source                                                                                      = "git::ssh://git@bitbucket.agile.corp.kpmg.pt:7999/ica/terraform-azure-azurerm-policies-sql-server.git"
    ...
    azurerm_policy_assignment_parameter_sqlSecurityThreatDetectionEmailAddresses                = "joaopedro.soares@kpmg.com"
}
```
