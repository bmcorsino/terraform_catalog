resource "azurerm_linux_web_app" "main_linux" {
  ...
  site_config {
    ...
    application_stack {
      ...
      java_server               = var.azurerm_app_java_server
      java_server_version       = var.azurerm_app_java_server_version
      docker_image              = var.azurerm_app_docker_image
      docker_image_tag          = var.azurerm_app_docker_image_tag
      ruby_version              = var.azurerm_app_ruby_version 
    }
  }
