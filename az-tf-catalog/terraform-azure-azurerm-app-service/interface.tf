...
variable "azurerm_app_service_site_config_scm_type" {
    description = "Azure App Service Site Config scm type"
    default = "LocalGit"
}
...
variable "azurerm_app_service_site_config_dotnet_framework_version" {
    description = "Azure App Service Site Config dotnet framework version"
    default = "v4.0"
}
