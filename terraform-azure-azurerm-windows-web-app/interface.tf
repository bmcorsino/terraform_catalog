...
variable "backup_schedule_retention_period_in_days" {
    default = 21
}
variable "backup_schedule_keep_at_least_one_backup" {
    default = true
}
variable "azurerm_app_current_stack" { 
}
...
variable "azurerm_app_java_container" {
}
variable "azurerm_app_java_container_version" {
}
variable "azurerm_app_python_version" {
}
variable "azurerm_app_php_version" {  
}
variable "azurerm_app_docker_container_name" {
}
variable "azurerm_app_docker_container_registry" {
}
variable "azurerm_app_docker_container_tag" {
}