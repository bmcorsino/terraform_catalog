    ...
    azurerm_single_database_list                        = [
        {
            ...
            # IN CASE OF NEW YOU DO NOT CHOOSE THE DBSERVER NAME, IT WILL BE DEFINED BY THE DXC/DXC STANDARD (e.g <application>-<environment>-sql-<seq number>)
            ...
            # IN CASE OF NEW YOU DO NOT CHOOSE THE ELASTIC_POOL NAME, IT WILL BE DEFINED BY THE DXC/DXC STANDARD (e.g <application>-<environment>-sqlelasticpool-<seq number>)
            ...
            # YOU DO NOT CHOOSE THE DATABASE NAME, IT WILL BE DEFINED BY THE DXC/DXC STANDARD (e.g <application>-<environment>-sqldb-<seq number>)
            # IF EMPTY name, a new ELASTIC_POOL will be created and we will use the EDITION, DTU, DTU_MAX, DTU_SIZE fields,
            database_data = {
