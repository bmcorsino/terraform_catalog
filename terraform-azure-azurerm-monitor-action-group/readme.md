...
module "azurerm_budget_action_group" {
    #Module source
    source = "git::ssh://git@bitbucket.agile.corp.dxc.pt:7999/ica/terraform-azure-azurerm-monitor-action-group.git?sourceBranch=refs/heads/feature/add-azure-mag-module"
