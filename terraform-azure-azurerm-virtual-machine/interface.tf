...
variable "azurerm_virtual_machine_delete_os_disk_on_termination" {
  description = "Azure virtual machine option to delete os disk on termination"
  default     = true
}
variable "azurerm_virtual_machine_delete_data_disks_on_termination" {
  description = "Azure virtual machine option to delete data disk on termination"
  default     = true
}
variable "azurerm_virtual_machine_is_windows_image" {
  description = "Azure virtual machine Windows options"
  default     = false
}
...
## OS profile
variable "azurerm_virtual_machine_os_profile_admin_username" {
...
variable "azurerm_virtual_machine_os_profile_custom_data" {
  description = "Azure virtual machine OS profile custom data"
  default     = ""
}

## OS profile linux config
variable "azurerm_virtual_machine_os_profile_linux_ssh_keys_key_data" {
  description = "Virtual machine OS ssh key data"
  default     = ""
}

## OS profile windows config
variable "azurerm_virtual_machine_os_profile_windows_provision_vm_agent" {
  description = "Azure virtual machine install guest agent"
  default     = "true"
}
variable "azurerm_virtual_machine_os_profile_windows_enable_automatic_upgrades" {
  description = "Azure virtual machine enable automatic upgrades"
  default     = "false"
}
variable "azurerm_virtual_machine_os_profile_windows_timezone" {
...
variable "azurerm_virtual_machine_license_type" {
