...
module vault {
  ...
  source                    = "git::ssh://git@bitbucket.agile.corp.edp.pt:7999/DKV/vault-infra-azure-integration.git?ref=v1.0.0"
  ...
  #(Mandatory) - Azure Subscription Name - Pattern Name [EDP-AZR-<BU>-<ENV>-<SEQUENCE>]
  azure_subscription_name   = "EDP-AZR-DGU-DEV-01"
