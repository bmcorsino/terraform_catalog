...
variable "address_space" {
  ...
  default     = ["10.218.0.0/19","10.218.32.0/19"]
}

# If no values specified, this defaults to Azure DNS 
variable "dns_servers" {
  description = "The DNS servers to be used with vNet."
  default     = ["10.10.0.0", "10.10.0.1"]
}

variable "subnet_prefixes" {
  description = "The address prefix to use for the subnet."
  default     = ["10.218.0.32/27", "10.218.0.128/25", "10.218.3.0/25", "10.218.0.64/28", "10.218.2.128/25", "10.218.4.0/22", "10.218.1.128/25", "10.218.3.128/25", "10.218.0.0/27", "10.218.1.0/25", "10.218.2.0/25"]
}
